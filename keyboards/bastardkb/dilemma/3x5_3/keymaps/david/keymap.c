...
#define BSP_NUM LT(LAYER_NUMERAL, XXXXXXX)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LAYER_BASE] = LAYOUT_split_3x5_3(
       ...
       LGUI_T(KC_A), LALT_T(KC_S), LCTL_T(KC_D), LSFT_T(KC_F), KC_G, KC_H, RSFT_T(KC_J), RCTL_T(KC_K), RALT_T(KC_L), RGUI_T(KC_BSPC),
 ...
 */
  [LAYER_NAVIGATION] = LAYOUT_split_3x5_3(
    ...
    KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, XXXXXXX, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, KC_CAPS,
 ...
 */
  [LAYER_NUMERAL] = LAYOUT_split_3x5_3(
    ...
    KC_SCLN,    KC_4,    KC_5,    KC_6,  KC_EQL, XXXXXXX, KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI,
     KC_SLSH,    KC_1,    KC_2,    KC_3, KC_BSLS, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                       KC_QUOTE, KC_MINS,    KC_0, XXXXXXX, _______, XXXXXXX
  ),
 ...
 */
  [LAYER_SYMBOLS] = LAYOUT_split_3x5_3(
    ...
    KC_COLN,  KC_QUES, KC_PERC, KC_CIRC, KC_PLUS, XXXXXXX, KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI,
    KC_GRAVE, KC_EXLM,   KC_AT, KC_HASH, KC_PIPE, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
